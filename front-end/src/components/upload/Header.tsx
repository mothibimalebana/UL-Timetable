export default function UploadHeader(){
    return(
        <div className="upload-header bg-blue flex flex-col gap-[1rem] px-[1rem] py-[3.2rem] rounded-[0.625rem] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.10)_0_4px_6px_-4px_rgba(0,0,0,0.10)}">
